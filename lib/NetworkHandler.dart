...
class NetworkHandler {
  String baseurl = "http://192.168.168.123:180";
  var log = Logger();
  ...
  Future<http.Response> patch1(String url, Map<String, String> body) async {
    ...
    var response = await http.patch(Uri.parse(
      ...
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IkluZHJhIGNoYW5kIiwiaWF0IjoxNjQ2MTQ1MzkwfQ.YKjczlyJoCP9qgFbDwkD90MEtAIdtnGlUVh3fd8FHhA"
      },
      body: json.encode(body),
    );
    return response;
